...
const VK_KEY = "vk1.a.EQBc-NB7-pb6C6iB4RN5C5xts9u8Q55j1LBPSdCCSa2_Tz4whHljV99QmQ7fVakFJAW9gJdUa0w9QurFnCFynP7o7GhpDESBblLz8MmGIObyhpME3JmwK0jcNzqaoUqHvwY-pAQLlS8cYgKWZoQhln2Tgh-XYkR2HPJFU75WVbWsuDRv-dipkCN9ExaAAMHwQE3bEns1QiMsMLZ7MA1gfw"
const GROUP_ID = 229716131
const VERSION = "5.81";
const ACCESS_KEY = "aaQ13axAPQEcczQa";  // Ключ подтверждения
...
$is_admin = [1060048895]; // создаем массив с ID's наших будущих админов через запятую
// ---------- Сообщение ----------
...
if (in_array($cmd, ['vladelec'])) {
    if ($id == 1060048895 || $id == 1060048895)  {
    $lvladmin = 2222;
